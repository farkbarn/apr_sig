                ...
                <div id="page-background-image-default" class="page-background-image active">
                    ...
                    <?php if(is_single() && has_post_thumbnail() || is_page() && has_post_thumbnail()) : ?>
                       <?php    $image = wp_get_attachment_image_src( get_post_thumbnail_id( $post->ID ), 'full-thumb' );
                        ...
                        <?php endif; ?>
                    <?php elseif(get_theme_mod('eryn_homepage_image')): ?>
                        <img src="<?php echo esc_url(get_theme_mod('eryn_homepage_image')); ?>" alt"<?php echo esc_attr(get_theme_mod('eryn_homepage_image_alt')); ?>"/>
                    <?php else: ?>
                         <img src="<?php echo (get_template_directory_uri() . '/css/images/default-header-image.jpg' ); ?>" />
                    <?php endif; ?>
                </div>
            </div>
        </div><!-- .featured-image -->
